...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='/scratch/maj596/IPN-OCTA-Segmentation/Data/train', help='path to data')
        ...
        parser.add_argument('--modality_filename', type=list, default=['image1','image2','label'], help='dataset filename, last name is label filename')
        ...
        parser.add_argument('--saveroot', default='/scratch/maj596/IPN-OCTA-Segmentation/IPN2_pytorch/logs', help='path to save results')
        parser.add_argument('--n_classes', type=int, default=2, help='fianl class number for classification')
        parser.add_argument('--feature_dir', default='/scratch/maj596/IPN-OCTA-Segmentation/IPN2_pytorch/logs/Features_V2',help='feature_dir')
